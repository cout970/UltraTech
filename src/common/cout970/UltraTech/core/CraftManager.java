...
public static void registerCraft(){
		...
		GameRegistry.addShapedRecipe(new ItemStack(UltraTech.ItemName.get("EnergyTransmiter"),1),new Object[]{"rsr","ses","rsr",'r',Block.stone,'s',Item.redstone,'e',UltraTech.ItemName.get("LapisPearl")});//revisar
		...
		GameRegistry.addShapedRecipe(new ItemStack(UltraTech.ReactorWall,1),new Object[]{"aaa","aba","aaa",'a',UltraTech.ItemName.get("CarbonFiber"),'b',UltraTech.ItemName.get("AlloyPlate")});
		...
		GameRegistry.addShapedRecipe(new ItemStack(UltraTech.ReactorTank, 1), new Object[]{"aga","gpg","aga",'p',UltraTech.ItemName.get("AlloyPlate"),'a',UltraTech.ItemName.get("CarbonFiber"),'g',UltraTech.ItemName.get("SiliconPlate")});
		...
		GameRegistry.addShapedRecipe(new ItemStack(UltraTech.EnergyIO,1), new Object[]{"ici","cmc","ici",'i',UltraTech.ItemName.get("Grafeno"),'m',UltraTech.ItemName.get("EnergyTransmiter"),'c',new ItemStack(Item.dyePowder,1,4)});
		...
		GameRegistry.addShapedRecipe(new ItemStack(UltraTech.ItemName.get("CarbonPlate"),1), new Object[]{"ii","ii",'i',Item.coal});
		...
		//cvd recipes
		CVD_Recipe.addRecipe(new CVD_Recipe(new ItemStack(Item.coal), new ItemStack(Item.coal),new ItemStack(UltraTech.ItemName.get("Grafeno"),1)));
