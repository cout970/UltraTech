...
public static void registerCraft(){
		...
		GameRegistry.addShapedRecipe(new ItemStack(UltraTech.Satelite,1), new Object[]{"fff","cmc","fpf",'f',UltraTech.ItemName.get("CarbonFiber"),'m',UltraTech.MachineChasis,'p',UltraTech.ItemName.get("EnergyTransmiter"),'c',UltraTech.ItemName.get("OpticFiber")});
