...
public class FluidUtils {
	...
	public static void onBlockAdded(World w, int x, int y, int z) {
		...
		if(!(w.getBlockTileEntity(x, y, z) instanceof IFluidTransport))return;
		IFluidTransport te = (IFluidTransport) w.getBlockTileEntity(x, y, z);
	...
	public static TileEntity getRelative(TileEntity from, ForgeDirection dir) {
		return from.worldObj.getBlockTileEntity(from.xCoord+dir.offsetX, from.yCoord+dir.offsetY, from.zCoord+dir.offsetZ);
	}
}
