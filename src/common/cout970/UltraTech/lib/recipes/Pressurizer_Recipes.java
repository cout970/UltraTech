...
public class Pressurizer_Recipes {
	...
	private static boolean isEqual(Pressurizer_Recipes a, Pressurizer_Recipes b) {
		if(UT_Utils.areEcuals(a.getImput1(), b.getImput1(),true) && UT_Utils.areEcuals(a.getImput2(), b.getImput2(),true) && UT_Utils.areEcuals(a.getImput3(), b.getImput3(),true)){
			return true;
		}
		return false;
	}
