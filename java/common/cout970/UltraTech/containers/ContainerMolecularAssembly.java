...
public class ContainerMolecularAssembly extends Container{

	private TileEntityMolecularAssembly tileEntity;

	public ContainerMolecularAssembly(InventoryPlayer inventoryPlayer, TileEntityMolecularAssembly tileEntity2){
		super();
	...
	public void addCraftingToCrafters(ICrafting par1ICrafting)
	{
		...
		par1ICrafting.sendProgressBarUpdate(this, 1, (int)tileEntity.getCharge());
