...
public class ContainerMiner extends Container{
	...
	public TileEntityMiner entity;
	
	private final int CHEST_INVENTORY_ROWS = 4;
	private final int CHEST_INVENTORY_COLUMNS = 13;

	
	public ContainerMiner(InventoryPlayer inventoryPlayer, TileEntityMiner tileEntity2){
		super();
		entity = tileEntity2;
		int x = 0;
	...
	public void addCraftingToCrafters(ICrafting par1ICrafting)
    {
        ...
        par1ICrafting.sendProgressBarUpdate(this, 1, (int)entity.getCharge());
