...
public class CraftManager {
	...
	public static void registerCraft(){
		...
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(ThermoelectricGenerator_T1,1,0),new Object[]{"ooo","tmt","ooo",'o',"plateObsidian",'t',Tank,'m',new ItemStack(Chasis,1,0)}));										//lava generator T1
		...
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(ThermoelectricGenerator_T2,1,0),new Object[]{"ooo","tmt","ooo",'o',"plateObsidian",'t',Tank,'m',new ItemStack(Chasis,1,1)}));										//lava generator T2
		...
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(ThermoelectricGenerator_T2,1,0),new Object[]{"ggg","omo","gpg",'o',"plateObsidian",'m',ThermoelectricGenerator_T1,'p',"circuitElectric",'g',"plateGrafeno"}));					//lava generator T2
		...
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(ItemName.get("Flamethrower"),1), new Object[]{"tee","ppp","ooe",'t',Tank,'p',"pipeCopper",'o',"plateObalti"}));											//flamethrower
		...
		//deco
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(obaltiBlock,8),new Object[]{"oo","oo",'o',"plateObalti"}));																										//alien block
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(CovedGlass,8),new Object[]{"oo","oo",'o',"plateSilicon"}));																									//coved glass
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(DiamondGlass,8),new Object[]{"xx","xx",'x',"plateDiamond"}));																									//diamond glass
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(MultiTank,16),new Object[]{"pgp","ggg","pgp",'p',"plateAluminum",'g',"blockGlass"}));																			//MultiTank
		...
		for(int i=0;i<8;i++){//black
			GameRegistry.addRecipe(new ShapelessOreRecipe(new ItemStack(stoneblockblack,1,i+1), new ItemStack(stoneblockblack,1,i)));
		}
		...
		for(int i=0;i<8;i++){//white
			GameRegistry.addRecipe(new ShapelessOreRecipe(new ItemStack(stoneblockwhite,1,i+1), new ItemStack(stoneblockwhite,1,i)));
		}
		...
		for(int i=0;i<8;i++){//normal
			GameRegistry.addRecipe(new ShapelessOreRecipe(new ItemStack(stoneblocknormal,1,i+1), new ItemStack(stoneblocknormal,1,i)));
		}
		GameRegistry.addRecipe(new ShapelessOreRecipe(new ItemStack(stoneblocknormal,1), new ItemStack(stoneblocknormal,1,8)));

		for(int i=0;i<8;i++){//clay
			GameRegistry.addRecipe(new ShapelessOreRecipe(new ItemStack(stoneblockclay,1,i+1), new ItemStack(stoneblockclay,1,i)));
		}
		GameRegistry.addRecipe(new ShapelessOreRecipe(new ItemStack(stoneblockclay,1), new ItemStack(stoneblockclay,1,8)));

		//decoblocks
		for(int meta = 0; meta < 8; meta++)
			GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(deco.get(meta),8),new Object[]{"iii","isi","iii",'i',new ItemStack(stoneblockblack, 1, meta),'s',new ItemStack(Items.redstone)}));

		for(int meta = 8; meta < 16; meta++)
			GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(deco.get(meta),8),new Object[]{"iii","isi","iii",'i',new ItemStack(stoneblockwhite, 1, meta-8),'s',new ItemStack(Items.redstone)}));
