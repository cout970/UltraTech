...
public class TileEntityCrafter extends SyncTile implements IInventory,IRedstoneControl{
...
//	}
	...
	public void sendGUINetworkData(ContainerCrafter containerCrafter,
			ICrafting iCrafting) {
		iCrafting.sendProgressBarUpdate(containerCrafter, -1, 0);
		for(int g=0; g < 9; g++){
			iCrafting.sendProgressBarUpdate(containerCrafter, g, (found[g])? 1 : 0);
		}
		iCrafting.sendProgressBarUpdate(containerCrafter, -2, 0);
	}
