...
public class TileEntityThermoelectricGeneratorT1 extends Machine implements IFluidHandler,IUpdatedEntity{
	...
	public TileEntityThermoelectricGeneratorT1() {
	...
	public TankUT getTank(){
		if(lava == null)lava = new TankUT(4000,this);
		return lava;
	}
