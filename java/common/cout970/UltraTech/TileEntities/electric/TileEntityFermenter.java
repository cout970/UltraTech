...
public class TileEntityFermenter extends MachineWithInventory implements  IFluidHandler{

	public TileEntityFermenter() {
		super(1, "Fermenter",MachineData.Fermenter);
	}

	public TankUT water = null;
	public TankUT juice = null;
	...
	public void updateEntity(){
		super.updateEntity();
		if(water == null)water = new TankUT(8000, worldObj, xCoord, yCoord, zCoord);
		if(juice == null)juice = new TankUT(8000, worldObj, xCoord, yCoord, zCoord);
