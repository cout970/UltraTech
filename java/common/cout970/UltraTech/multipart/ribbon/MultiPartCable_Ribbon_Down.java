...
public class MultiPartCable_Ribbon_Down extends MultiPartCable_Ribbon{
	...
	public void updateConnections(){
		...
		for(ICable c : NetworkManagerRegistry.getConnections(tile())){
			if(c != this.getPower().getCable()){
				ForgeDirection side = c.getInternalConection(CableType.Ribbon_Down, getPower().getCable());
