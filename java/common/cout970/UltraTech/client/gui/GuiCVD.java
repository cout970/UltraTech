...
public class GuiCVD extends GuiContainer{

	private TileEntityChemicalVaporDesintegrationT1 entity;
	
	public GuiCVD(Container par1Container,InventoryPlayer ip ,TileEntityChemicalVaporDesintegrationT1 entity) {
		super(par1Container);
		this.entity = entity;
	}
