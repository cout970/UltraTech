...
public class GuiCoalGenerator extends GuiContainer{
	...
	private TileEntityCoalGeneratorEntityT1 entity;
	
	public GuiCoalGenerator(Container par1Container,InventoryPlayer ip,TileEntityCoalGeneratorEntityT1 entity) {
		super(par1Container);
		this.entity = entity;
	}
