...
public class GuiReactor extends GuiMachineBase{

	public Reactor_Core_Entity tile;
	
	public GuiReactor(Container par1Container, InventoryPlayer inventory, TileEntity te) {
