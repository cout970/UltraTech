...
public class RenderPipe extends TileEntitySpecialRenderer{
	...
	public void renderTileEntityAt(TileEntity te, double x, double y,
		...
		TileEntityCopperPipe p = (TileEntityCopperPipe) te;
		...
		bindTexture(ModelResources.PIPE_BASE);
		...
		//
		//render in
		bindTexture(ModelResources.PIPE_IN);
		in.render(1/16f, a);

		bindTexture(ModelResources.PIPE_BASE_2);
		model.render(0.0625f,a);
		if(!p.mode)	bindTexture(ModelResources.PIPE_CONECTION1);
		else 		bindTexture(ModelResources.PIPE_CONECTION2);
