...
public class BlockChemicalVaporDesintegrationT2 extends BlockConductor{

	public IIcon[] icons;
	
	public BlockChemicalVaporDesintegrationT2(Material m) {
		super(m);
	...
	public TileEntity createNewTileEntity(World var1, int var2) {
		return new TileEntityChemicalVaporDesintegrationT2();
	}
