...
public class BlockChemicalVaporDesintegrationT1 extends BlockConductor{

	public IIcon[] icons;
	
	public BlockChemicalVaporDesintegrationT1(Material m) {
		super(m);
	...
	public TileEntity createNewTileEntity(World var1, int var2) {
		return new TileEntityChemicalVaporDesintegrationT1();
	}
