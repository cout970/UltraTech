...
public class BlockThermoelectricGeneratorT1 extends BlockConductor{

	private IIcon blockIcon2;

	public BlockThermoelectricGeneratorT1(Material m) {
		super(m);
	...
	public TileEntity createNewTileEntity(World var1, int var2) {
		return new TileEntityThermoelectricGeneratorT1();
	}
