...
public class BlockSteamTurbine extends BlockConductor{

	public BlockSteamTurbine(Material par2Material) {
		super(par2Material);
	...
	public boolean onBlockActivated(World w, int x, int y, int z, EntityPlayer p, int par6, float par7, float par8, float par9)
	{
		...
		TileEntitySteamTurbine e = (TileEntitySteamTurbine) w.getTileEntity(x, y, z);
		if(e != null){
