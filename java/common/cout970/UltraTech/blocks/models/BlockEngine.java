...
public class BlockEngine extends BlockConductor{

	public BlockEngine(Material par2Material) {
		super(par2Material);
	...
	public boolean onBlockActivated(World w, int x, int y, int z, EntityPlayer p, int par6, float par7, float par8, float par9)
	{
		...
		TileEntityEngine e = (TileEntityEngine) w.getTileEntity(x, y, z);
		if(e != null){
	...
	public void onNeighborBlockChange(World w, int x, int y, int z, Block side){
		TileEntityEngine m = (TileEntityEngine) w.getTileEntity(x, y, z);
