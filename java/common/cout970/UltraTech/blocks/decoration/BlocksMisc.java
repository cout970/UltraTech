...
public class BlocksMisc extends BlockContainer{

	private IIcon blockIconLast;
	private IIcon blockIcon1;

	public BlocksMisc(Material par2Material) {
		super(par2Material);
	...
	public TileEntity createNewTileEntity(World world, int metadata) {
		return (metadata == 3) ? null : new TileEntityHitBox();
	}
	...
	public void breakBlock(World world, int x, int y, int z, Block par5, int par6)
	{
		...
		if(t instanceof TileEntityHitBox){
			TileEntityHitBox h = (TileEntityHitBox) t;			
